  function  sif_generator_flux(name,project_path,bodies,mat1,mat2,nboundaries,boundary1,boundary2,boundary3,temp1,temp2,temp3)
  ...
  lb = sprintf('\n');
        ...
        fwrite(fileid,[' Vector Field 2 = Temperature Flux' lb]);
        fwrite(fileid,['End' lb]);
        fwrite(fileid, lb);
